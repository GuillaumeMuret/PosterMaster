...
public class EseoGetJuryInformationRequest extends EseoBaseRequest {

    public static final String REQUEST_GET_JURY_INFORMATION ="REQUEST_GET_JURY_INFORMATION";

    public static boolean isRequestRunning = false;

    private int juryId;

    public EseoGetJuryInformationRequest(String requestId, boolean isShowLoadingDialog, Context context, Users appUser, int juryId) {
    ...
    protected Call createCall(Object interfaceObject) {
        Call call = ((EseoService)interfaceObject).getJuryInformation(
                ProtocolVocabulary.PROCESS_GET_PROJECT_JURIES_INFO,
